...
{ // Рабочие параметры
    ...
    constexpr double GRAV_PARAMETER = 0.06;                                   // Гравитационный параметр (GM)
    ...
    constexpr double MAGNETIC_MOMENT = 1e-7 * 1;                              // На самом деле подгон  // Магнитный дипольный момент Марса
    constexpr double SOLAR_WIND_VELOCITY = 10;                                // Скорость частиц солнечного ветра
